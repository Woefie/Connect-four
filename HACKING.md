...
hidden if the `connect-four_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `connect-four_DEVELOPER_MODE` to the configure
...
Runs the executable target `connect-four_exe`.
